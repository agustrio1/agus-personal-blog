...
// Optimasi: Komponen loading yang lebih ringan
  ...
  return (
    <div className="grid md:grid-cols-2 gap-8">
      {Array.from({ length: 4 }).map((_, i) => (
        <div
          key={i}
          className="bg-white/60 dark:bg-black/20 rounded-3xl p-6 md:p-8 animate-pulse"
        >
...
export default async function Home() {
  // Optimasi: Parallel data fetching
  ...
  const settings = {
    ...
    blogDescription:
      rawSettings.blogDescription ?? "Selamat datang di blog saya.",
  };
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50/50 via-white to-purple-50/50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900/20">
      ...
      {/* SEO Section - Above the fold */}
      <section className="max-w-4xl mx-auto px-4 mb-8">
        <h2 className="text-2xl font-bold mb-2 text-center">
          Jasa Pembuatan Website Kediri, Surabaya, Jakarta, Bandung
        </h2>
        <p className="text-center text-gray-700 dark:text-gray-200">
          Kami melayani jasa pembuatan website profesional untuk bisnis dan
          personal di Kediri, Surabaya, Jakarta, dan Bandung. Konsultasi gratis,
          pengerjaan cepat, dan support penuh untuk kebutuhan digital Anda!
        </p>
      </section>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/80 dark:bg-black/30 rounded-2xl p-8 shadow-lg flex flex-col items-center text-center border border-white/20 dark:border-white/10">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Artikel dan insight mendalam, praktis, dan selalu up-to-date untuk
              pengembangan diri & bisnis Anda.
            </p>
          </div>
          <div className="bg-white/80 dark:bg-black/30 rounded-2xl p-8 shadow-lg flex flex-col items-center text-center border border-white/20 dark:border-white/10">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Analisis mendalam untuk merancang strategi konten dan produk yang
          ...
          <div className="bg-white/80 dark:bg-black/30 rounded-2xl p-8 shadow-lg flex flex-col items-center text-center border border-white/20 dark:border-white/10">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Membangun solusi digital yang cepat, aman, dan skalabel untuk
      ...
      <section className="max-w-5xl mx-auto px-4 mb-20">
        ...
        {/* Direct render tanpa Suspense untuk performa */}
        <div className="grid md:grid-cols-2 gap-8">
      ...
      {/* Quick Links - Lazy loaded */}
      <Suspense
        fallback={
          <div className="h-64 animate-pulse bg-gray-100 dark:bg-gray-800 rounded-2xl mx-4"></div>
        }
      >
        <QuickLinksSection />
      </Suspense>
...
// Komponen terpisah untuk Quick Links (lazy loaded)
        ...
        {[
          {
            href: "/projects",
            title: "Portfolio",
            desc: "Lihat project terbaru & studi kasus",
            icon: "🚀",
          },
          {
            href: "/about",
            title: "Tentang",
            desc: "Kenali lebih dekat siapa saya & visi blog ini",
            icon: "👋",
          },
          {
            href: "/contact",
